        ...
        if should_run:
            ...
            try:
                ...
                if not game_list:
                    ...
                    await epic_games_channel.send("Couldn't retrieve free games information this week.")
                    self._force_next_run = False
                    return
                ...
                if messages_to_send:
                    ...
                    for msg_url in messages_to_send:
                        await epic_games_channel.send(msg_url)
                else:
                    await epic_games_channel.send("No new free games found for this week, or already announced.")

            except requests.exceptions.RequestException as e:
                logger.error(f"Request error fetching Epic Games: {e}")
                await epic_games_channel.send("An error occurred while fetching free Epic Games. Please try again later.")
                ...
                await epic_games_channel.send("An error occurred processing Epic Games data. Please try again later.")
                ...
                await epic_games_channel.send("An unexpected error occurred with Epic Games task.")
