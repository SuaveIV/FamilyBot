...
HISTORICAL_LOW_BUFFER = 1.2    # Allow price up to 20% above historical low for "great deal"
...
MIN_ELAPSED_TIME_FOR_ESTIMATION = 1  # Minimum seconds elapsed before showing time estimation
